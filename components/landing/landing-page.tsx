...
const flowSteps = [
  ...
  },
  {
    ...
    description: "Agenda, equipe, serviços e clientes no mesmo lugar.",
...
const proofItems = [
  ...
  },
  {
    ...
    description: "Assinaturas e benefícios visóveis para a gestão.",
    icon: CreditCardIcon,
  },
]
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Sim. A barbearia gerencia agendamentos, serviços, planos e relacionamento com clientes pelo painel administrativo.",
  },
  {
        ...
        <div className="mx-auto w-full max-w-[1200px] min-w-0 bg-white px-5 pt-20 text-[var(--landing-primary-dark)] sm:px-8 md:px-12 lg:px-16">
          ...
          <div className="border-t border-dashed border-[var(--landing-border)] py-8">
            ...
            <div className="mt-8 flex flex-col gap-5 text-xs font-semibold text-[var(--landing-muted)] md:flex-row md:items-center md:justify-between">
              <p>
                Copyright é 2026 Bigood Tecnologia. Sistema de gestão para
                barbearias.
              </p>
              <div className="flex items-center gap-3">
                {["IG", "YT", "X"].map((item) => (
